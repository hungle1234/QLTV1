...
{
    public partial class FormCapNhatDocGia : Form
    {
        public FormCapNhatDocGia()
        {
            InitializeComponent();
        }
        ...
        {
            if (MessageBox.Show("Bạn có muốn xóa"+txtHOTEN.Text+"không?(Y/N)", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
